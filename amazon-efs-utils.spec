...
Version  : 1.25.3
Release  : 19
URL      : https://github.com/aws/efs-utils/archive/v1.25-3/efs-utils-1.25.3.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.25-3/efs-utils-1.25.3.tar.gz
...
%prep
%setup -q -n efs-utils-1.25-3
cd %{_builddir}/efs-utils-1.25-3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591108359
...
cp %{_builddir}/efs-utils-1.25-3/LICENSE %{buildroot}/usr/share/package-licenses/amazon-efs-utils/b8c10789883a17bc1d0e9f763547f739436dec29
%make_install
