...
Version  : 2.0.0
Release  : 49
URL      : https://github.com/aws/efs-utils/archive/v2.0.0/efs-utils-2.0.0.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v2.0.0/efs-utils-2.0.0.tar.gz
...
%prep
%setup -q -n efs-utils-2.0.0
cd %{_builddir}/efs-utils-2.0.0
%patch -P 1 -p1
pushd ..
cp -a efs-utils-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713033960
