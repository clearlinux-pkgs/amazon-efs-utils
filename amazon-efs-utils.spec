...
Version  : 1.33.3
Release  : 37
URL      : https://github.com/aws/efs-utils/archive/v1.33.3/efs-utils-1.33.3.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.33.3/efs-utils-1.33.3.tar.gz
...
%prep
%setup -q -n efs-utils-1.33.3
cd %{_builddir}/efs-utils-1.33.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660055540
