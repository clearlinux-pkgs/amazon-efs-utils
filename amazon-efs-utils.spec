...
Version  : 1.13
Release  : 8
URL      : https://github.com/aws/efs-utils/archive/v1.13/efs-utils-1.13.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.13/efs-utils-1.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572365265
...
cp %{_builddir}/efs-utils-1.13/LICENSE %{buildroot}/usr/share/package-licenses/amazon-efs-utils/b8c10789883a17bc1d0e9f763547f739436dec29
%make_install
