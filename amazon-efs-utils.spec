...
Source0  : https://github.com/aws/efs-utils/archive/v1.32.2/efs-utils-1.32.2.tar.gz
...
%prep
%setup -q -n efs-utils-1.32.2
cd %{_builddir}/efs-utils-1.32.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651248105
...
cp %{_builddir}/efs-utils-1.32.2/LICENSE %{buildroot}/usr/share/package-licenses/amazon-efs-utils/b8c10789883a17bc1d0e9f763547f739436dec29
%make_install
