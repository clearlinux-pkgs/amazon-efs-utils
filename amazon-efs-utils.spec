...
Version  : 1.34.4
Release  : 42
URL      : https://github.com/aws/efs-utils/archive/v1.34.4/efs-utils-1.34.4.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.34.4/efs-utils-1.34.4.tar.gz
...
%prep
%setup -q -n efs-utils-1.34.4
cd %{_builddir}/efs-utils-1.34.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671030263
