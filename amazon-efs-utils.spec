...
Version  : 1.16
Release  : 12
URL      : https://github.com/aws/efs-utils/archive/v1.16/efs-utils-1.16.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.16/efs-utils-1.16.tar.gz
...
%prep
%setup -q -n efs-utils-1.16
cd %{_builddir}/efs-utils-1.16
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575556715
...
cp %{_builddir}/efs-utils-1.16/LICENSE %{buildroot}/usr/share/package-licenses/amazon-efs-utils/b8c10789883a17bc1d0e9f763547f739436dec29
%make_install
