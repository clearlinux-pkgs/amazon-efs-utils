...
Version  : 2.0.3
Release  : 52
URL      : https://github.com/aws/efs-utils/archive/v2.0.3/efs-utils-2.0.3.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v2.0.3/efs-utils-2.0.3.tar.gz
...
%prep
%setup -q -n efs-utils-2.0.3
cd %{_builddir}/efs-utils-2.0.3
%patch -P 1 -p1
pushd ..
cp -a efs-utils-2.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718816217
