...
Source0  : https://github.com/aws/efs-utils/archive/v1.34.3/efs-utils-1.34.3.tar.gz
...
%prep
%setup -q -n efs-utils-1.34.3
cd %{_builddir}/efs-utils-1.34.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670487803
