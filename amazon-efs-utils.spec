...
Version  : 1.29.1
Release  : 26
URL      : https://github.com/aws/efs-utils/archive/v1.29.1/efs-utils-1.29.1.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.29.1/efs-utils-1.29.1.tar.gz
...
%prep
%setup -q -n efs-utils-1.29.1
cd %{_builddir}/efs-utils-1.29.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612798074
...
cp %{_builddir}/efs-utils-1.29.1/LICENSE %{buildroot}/usr/share/package-licenses/amazon-efs-utils/b8c10789883a17bc1d0e9f763547f739436dec29
%make_install
