...
Version  : 1.36.0
Release  : 48
URL      : https://github.com/aws/efs-utils/archive/v1.36.0/efs-utils-1.36.0.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.36.0/efs-utils-1.36.0.tar.gz
...
%prep
%setup -q -n efs-utils-1.36.0
cd %{_builddir}/efs-utils-1.36.0
%patch -P 1 -p1
pushd ..
cp -a efs-utils-1.36.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711029055
