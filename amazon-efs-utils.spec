...
Source0  : https://github.com/aws/efs-utils/archive/v1.35.1/efs-utils-1.35.1.tar.gz
...
%prep
%setup -q -n efs-utils-1.35.1
cd %{_builddir}/efs-utils-1.35.1
%patch -P 1 -p1
pushd ..
cp -a efs-utils-1.35.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705699734
