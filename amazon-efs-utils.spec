...
Source0  : https://github.com/aws/efs-utils/archive/v1.35.0/efs-utils-1.35.0.tar.gz
...
%prep
%setup -q -n efs-utils-1.35.0
cd %{_builddir}/efs-utils-1.35.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701933259
