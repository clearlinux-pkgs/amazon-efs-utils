...
Version  : 2.3.1
Release  : 58
URL      : https://github.com/aws/efs-utils/archive/v2.3.1/efs-utils-2.3.1.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v2.3.1/efs-utils-2.3.1.tar.gz
...
%prep
%setup -q -n efs-utils-2.3.1
cd %{_builddir}/efs-utils-2.3.1
%patch -P 1 -p1
pushd ..
cp -a efs-utils-2.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747320034
