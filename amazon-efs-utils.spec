...
Version  : 1.33.4
Release  : 38
URL      : https://github.com/aws/efs-utils/archive/v1.33.4/efs-utils-1.33.4.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.33.4/efs-utils-1.33.4.tar.gz
...
%prep
%setup -q -n efs-utils-1.33.4
cd %{_builddir}/efs-utils-1.33.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663856502
