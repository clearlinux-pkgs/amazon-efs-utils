...
Version  : 1.34.1
Release  : 39
URL      : https://github.com/aws/efs-utils/archive/v1.34.1/efs-utils-1.34.1.tar.gz
Source0  : https://github.com/aws/efs-utils/archive/v1.34.1/efs-utils-1.34.1.tar.gz
...
%prep
%setup -q -n efs-utils-1.34.1
cd %{_builddir}/efs-utils-1.34.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665845841
